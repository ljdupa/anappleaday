import svgPaths from "./svg-htiz45rvlc";
...
function Apple() {
  return (
    <div className="absolute h-[252.5px] left-[87px] top-[285px] w-[222.938px]" data-name="apple4">
      <div className="absolute inset-[-1.44%_-4.93%_-9.11%_-7.63%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 250.938 279.125">
          <g filter="url(#filter0_d_2_191)" id="apple4">
            <path d={svgPaths.p57f6000} fill="url(#paint0_linear_2_191)" id="Ellipse 11" />
            <ellipse cx="79" cy="158.125" fill="var(--fill-0, black)" id="smile" rx="5" ry="17.5" />
            <ellipse cx="183" cy="158.125" fill="var(--fill-0, black)" id="smile_2" rx="5" ry="17.5" />
            <path d={svgPaths.pfe21c00} fill="var(--fill-0, black)" id="smile_3" />
            <path d={svgPaths.p3597dc00} fill="var(--fill-0, #272525)" id="Ellipse 5" />
            <path d={svgPaths.p12d2d00} fill="var(--fill-0, #272525)" id="stems" />
            <ellipse cx="181.673" cy="93.9558" fill="var(--fill-0, black)" id="Ellipse 20" rx="7.62549" ry="4.13436" transform="rotate(29.2156 181.673 93.9558)" />
            <path d={svgPaths.p5e0b600} fill="var(--fill-0, #C38B8B)" id="Ellipse 17" />
            <path d={svgPaths.pfdf9f00} fill="var(--fill-0, #DCBEBE)" id="Rectangle 15" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="279.125" id="filter0_d_2_191" width="250.938" x="0" y="-1.19209e-07">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_2_191" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_2_191" mode="normal" result="shape" />
            </filter>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2_191" x1="192" x2="69" y1="105.125" y2="260.125">
              <stop stopColor="#9C865C" />
              <stop offset="0.8796" stopColor="#59462E" />
              <stop offset="1" stopColor="#372518" />
            </linearGradient>
          </defs>
        </svg>
      </div>
  ...
  return (
    <div className="absolute contents left-[68px] top-[593px]" data-name="miniapples">
      ...
      <div className="absolute h-[29px] left-[291px] top-[603px] w-[33px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 33 29">
          <path d={svgPaths.p886f580} fill="url(#paint0_linear_2_122)" id="Ellipse 15" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2_122" x1="16.5" x2="16.5" y1="1.30865e-08" y2="29">
...
export default function IPhone16Badapple({
  onSetMood,
}: {
  onSetMood: () => void;
}) {
  return (
    <div className="bg-[#f1eed9] relative size-full" data-name="iPhone 16 - badapple">
      <p className="-translate-x-1/2 absolute left-1/2 top-[162px] text-[#394648] text-[20px] text-center whitespace-nowrap font-cabin">
  Hi Lauren!
</p>
...
<p className="-translate-x-1/2 absolute left-1/2 top-[569px] text-[20px] text-center whitespace-nowrap font-cabin text-[#394648]">
  <span>I feel </span>
  <span className="font-bold text-[#836F49]">meh</span>
</p>
      <Miniapples />
