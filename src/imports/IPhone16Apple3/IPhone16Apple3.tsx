import svgPaths from "./svg-g7h5hk0d4w";
...
function Apple() {
  return (
    <div className="absolute h-[252.5px] left-[86px] top-[285px] w-[222.938px]" data-name="apple3">
      <div className="absolute inset-[-1.44%_-4.93%_-9.11%_-7.63%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 250.938 279.125">
          <g filter="url(#filter0_d_2_235)" id="apple3">
            <path d={svgPaths.p1d4c5660} fill="url(#paint0_linear_2_235)" id="Ellipse 11" />
            <ellipse cx="79" cy="154.125" fill="var(--fill-0, black)" id="smile" rx="5" ry="17.5" />
            <ellipse cx="183" cy="154.125" fill="var(--fill-0, black)" id="smile_2" rx="5" ry="17.5" />
            <path d={svgPaths.p22cfe300} fill="var(--fill-0, black)" id="smile_3" />
            <path d={svgPaths.p31ab65c0} fill="var(--fill-0, #272525)" id="Ellipse 5" />
            <path d={svgPaths.p12d2d00} fill="var(--fill-0, #272525)" id="stems" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="279.125" id="filter0_d_2_235" width="250.938" x="0" y="-1.19209e-07">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_2_235" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_2_235" mode="normal" result="shape" />
            </filter>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2_235" x1="58" x2="287.5" y1="267.126" y2="19.6256">
              <stop stopColor="#DD9D1D" />
              <stop offset="0.528208" stopColor="#FBDD12" />
              <stop offset="0.969059" stopColor="#FFF5B5" />
            </linearGradient>
          </defs>
        </svg>
      </div>
...
export default function IPhone16Mehapple({
  onSetMood,
}: {
  onSetMood: () => void;
}) {
  return (
    <div className="bg-[#f1eed9] relative size-full" data-name="iPhone 16 - mehapple">
      <p className="-translate-x-1/2 absolute left-1/2 top-[162px] text-[#394648] text-[20px] text-center whitespace-nowrap font-cabin">
        Hi Lauren!
      </p>
      ...
      <p className="-translate-x-1/2 absolute left-1/2 top-[569px] text-[20px] text-center whitespace-nowrap font-cabin text-[#394648]">
        I feel{" "}
        <span className="font-bold text-[#FBDD12]">okay</span>
      </p>
