...
export default function SignUpScreen({ onCreateAccount, onSignIn }: SignUpScreenProps) {
  ...
  return (
    <div className="relative h-[852px] w-[393px] overflow-hidden" style={cabin}>
      <div
        ...
        style={{ background: "linear-gradient(135deg, #BAC15B 0%, #999f40 100%)" }}
      />
      <div
        className="absolute top-[160px] left-0 w-full bg-[#F1EED9]"
        style={{ borderTopLeftRadius: "38px", borderTopRightRadius: "38px", bottom: 0 }}
      >
        <div className="flex flex-col items-center pt-[48px] pb-[36px]">
          <p style={{ ...cabinBold, fontSize: "48px", color: "#BAC15B" }}>Sign Up</p>
        </div>

        <div className="mx-[27px] mb-[24px] relative">
        ...
        <div className="mx-[27px] mb-[16px]">
          <button
            onClick={() => onCreateAccount(name)}
            className="w-full h-[52px] rounded-[13px] text-white text-[20px] cursor-pointer"
            style={{ ...cabinBold, background: "linear-gradient(135deg, #BAC15B 0%, #999f40 100%)" }}>
            Create Account
          </button>
        </div>
        ...
        <div className="flex justify-center">
          <p style={{ ...cabin, color: "#394648", fontSize: "15px" }}>
            ...
            <button onClick={onSignIn}
              style={{ color: "#D31E1E", textDecoration: "underline", fontFamily: "Cabin Condensed, sans-serif", fontWeight: 700 }}>
              Sign in
            </button>
          </p>
        </div>
