...
interface ReceivedApplesScreenProps {
...
const receivedApples = [
  { id: '1', date: 'Sat, May 2', username: 'jordan_smith', message: 'you inspire me!' },
  { id: '2', date: 'Sun, May 3', username: 'alex_parks', message: 'thinking of you!' },
  { id: '3', date: 'Sun, May 3', username: 'casey_lee', message: 'proud of you!' },
  { id: '4', date: 'Sun, May 3', username: 'riley_brown', message: 'you got this!' },
  { id: '5', date: 'Mon, May 4', username: 'morgan_white', message: 'stay strong!' },
  { id: '6', date: 'Mon, May 4', username: 'taylor_jones', message: 'rooting for you!' },
  { id: '7', date: 'Tue, May 5', username: 'sam_davis', message: 'keep going!' },
];
...
export default function ReceivedApplesScreen({
  onNavigateToHome,
  onNavigateToFriends,
  onNavigateToJournal,
  onNavigateToLogMood,
  ...
  return (
    <div className="relative h-[852px] w-[393px] mx-auto bg-[#bac15b] overflow-hidden">
      <div className="absolute inset-x-0 top-0 h-[140px] bg-[#efebd1] z-30">
        ...
        <button
          type="button"
          onClick={onNavigateToSentApples}
          className="absolute right-[20px] top-[65px] rounded-[18px] bg-[#d1ccab] px-[14px] py-[10px] text-[12px] font-[700] text-[#2D2323] hover:opacity-90 transition-opacity"
      ...
      <div className="absolute inset-x-0 top-[120px] bottom-[72px] bg-[#f3efd4] px-[20px] pb-[20px] pt-[18px] overflow-y-auto">
        <div className="rounded-[18px] bg-[#F8D150] px-[16px] py-[14px] shadow-[0px_4px_10px_rgba(0,0,0,0.12)]">
          <p className="text-[14px] font-[700] text-[#394648]" style={{ fontFamily: 'Cabin Condensed, sans-serif' }}>
            You've received 7 apples this week!
          </p>
        </div>

        <div className="mt-[16px] space-y-[13px]">
          {receivedApples.map((item, index) => (
